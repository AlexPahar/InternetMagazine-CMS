...
if ($_SESSION['auth_admin'] == "yes_auth")
{
  ...
  $_SESSION['urlpage'] = "<a href='index.php' >Главная</a> \ <a href='view_order.php' >Просмотр заказа</a>";
...
';
$query_product = mysql_query("SELECT * FROM buy_products,table_products WHERE buy_products.buy_id_order = '$id' AND table_products.product_id = buy_products.buy_id_product",$link);
...
<TD  align="CENTER" >'.$result_query["price"].' руб/шт</TD>
